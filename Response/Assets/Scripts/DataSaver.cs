...
public class DataSaver : MonoBehaviour
{
    ...
    private void OnBallAccepted(Ball obj)
    {
        ...
        saveData.reactionTime = (float)(obj.actionStartTime - LevelBehaviour.preciousActionCompleteTime).TotalMilliseconds;
...
public class SaveData 
{
    ...
    {
        return $"{ballColor},{actionTime},{reactionTime},{distance},{dropError},{missingError}";
    }
}